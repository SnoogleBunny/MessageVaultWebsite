        ...
        <div className="footer-container">
            <section className="footer-subscription">
                ...
                <div className="input-areas">
                    <form>
                        <input className="footer-input" type="email" name="email" placeholder="Your Email" classname="footer-input" />
                        <input className="footer-input" type="text" name="inquiry" placeholder="Your Inquiry" classname="footer-input" />
